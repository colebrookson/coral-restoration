...
# 0.01 is the lowest value and 0.96 is the highest value of min_coral, want
# these two to have distinctly different colours
# the values of min_coral are max 2 decimal points, so there are only 96
...
div_by_recruit <- ggplot(data = matching_df) +
  ...
  guides(color = "none")
ggsave(
  here::here("./graphs/conclusions-plots/min-coral-div-by-recruit.png"),
  div_by_recruit,
  height = 6, width = 10
)
div_by_comp <- ggplot(data = matching_df) +
  ...
  guides(color = "none")
ggsave(
  here::here("./graphs/conclusions-plots/min-coral-div-by-comp.png"),
  div_by_comp,
  height = 6, width = 10
)
...
ggsave(
  here::here("./graphs/conclusions-plots/min-coral-div-by-grazing.png"),
  div_by_grazing,
  height = 6, width = 10
)
